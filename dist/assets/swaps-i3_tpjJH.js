import{cD as P,di as l,cG as w,cH as I,cI as A,cZ as v,cP as h,cJ as u,d3 as z,cW as R,cS as $,c$ as M,dE as K,cX as F,cY as Q,cE as O,cF as H,dY as L}from"./index-RD9we72E.js";import{S as r}from"./SwapController-B0AAWFeB.js";import"./index-BNtN-mDe.js";const q={numericInputKeyDown(e,t,o){const n=["Backspace","Meta","Ctrl","a","A","c","C","x","X","v","V","ArrowLeft","ArrowRight","Tab"],s=e.metaKey||e.ctrlKey,i=e.key,a=i.toLocaleLowerCase(),c=a==="a",C=a==="c",W=a==="v",V=a==="x",U=i===",",_=i===".",N=i>="0"&&i<="9";!s&&(c||C||W||V)&&e.preventDefault(),t==="0"&&!U&&!_&&i==="0"&&e.preventDefault(),t==="0"&&N&&(o(i),e.preventDefault()),(U||_)&&(t||(o("0."),e.preventDefault()),(t?.includes(".")||t?.includes(","))&&e.preventDefault()),!N&&!n.includes(i)&&!_&&!U&&e.preventDefault()}},G=P`
  :host {
    width: 100%;
  }
...
`;var B=function(e,t,o,n){var s=arguments.length,i=s<3?t:n===null?n=Object.getOwnPropertyDescriptor(t,o):n,a;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(e,t,o,n);else for(var c=e.length-1;c>=0;c--)(a=e[c])&&(i=(s<3?a(i):s>3?a(t,o,i):a(t,o))||i);return s>3&&i&&Object.defineProperty(t,o,i),i};let E=class extends A{constructor(){super(...arguments),this.target="sourceToken"}render(){return u`
    ...
    `}};E.styles=[X];B([w()],E.prototype,"target",void 0);E=B([I("w3m-swap-input-skeleton")],E);const Z=P`
  :host > wui-flex {
    display: flex;
    flex-direction: row;
    justify-content: space-between;
